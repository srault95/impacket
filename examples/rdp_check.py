...
def check_rdp(host=None, username=None, password=None, domain='', hashes=None):
    ...
    if cr_tpdu['Type'] == TYPE_RDP_NEG_FAILURE:
        ...
        rdp_failure.dump()
        raise Exception("Server doesn't support PROTOCOL_HYBRID, hence we can't use CredSSP to check credentials")
    else:
...
def main(host=None, username=None, password=None, domain='', hashes=None):
    """
    ...
    return check_rdp(host, username, password, domain, hashes)

if __name__ == '__main__':
    import logging
    logging.basicConfig(level=logging.INFO)
    result = main(host='HOST', username="USER", password="PASSWORD")
    print('result : ', result)
